...
# local import
from module.simple_data_module import SimpleDataModule
from module.memory_cluster_trainer import ExampleModule
...
def main(cfg: DictConfig):
    ...
    datamodule = SimpleDataModule(**dataset_config)
